<div>
    ...
    <form wire:submit.prevent="submit" class="prose">
        ...
        <div class="mt-4">
            ...
            <x-select-input :options="$noteList" :value="'name'" :label="'name'" name="notes" id="notes"
                wire:model.live="notes"></x-select-input>
            <x-input-error :messages="$errors->get('notes')" class="mt-2" />
        </div>
        <div class="mt-4">
            <button class="bg-emerald-500 px-6 py-3 text-white rounded" type="submit">Save booking</button>
        </div>
    </form>
</div>
