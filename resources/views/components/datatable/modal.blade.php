        ...
        <div class="relative bg-slate-50 rounded-lg shadow ">
            ...
            <form action="{{ $deleteRoute }}" method="POST">
                ...
                <div class="flex items-center p-6 space-x-2 border-t border-slate-200 rounded-b ">
                    <button type="submit"
                        class="text-white bg-rose-700 hover:bg-rose-800 focus:ring-4 focus:outline-none focus:ring-rose-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Delete</button>
                    <button type="button"
                        class="text-slate-500 bg-white hover:bg-slate-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-slate-200 text-sm font-medium px-5 py-2.5 hover:text-slate-900 focus:z-10"
